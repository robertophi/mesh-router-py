...
class ControlsManager():
    def __init__(self, canvas, frame):
        ...
        self.button4 = Button(canvas, text='B4', fg='black', command=self.b4_command)
        ...
        self.label4 = Label(canvas, text='Button 4', fg='black', bg =self.canvas.config('bg')[4] ).place(x=20+self.bsize + self.bborder, y = 50+3*(self.bsize+self.bborder), height = self.bsize)


        self.text = Text(canvas, height=10, width=45)
        self.text.place(x=20, y = 550)
