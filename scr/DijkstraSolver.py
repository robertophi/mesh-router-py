...
class Graph():
    ...
    def get_distance(self, node_tx, node_rx):
        if node_tx == node_rx:
            ...
            [xc1, yc1, xc2, yc2] = [int(c / self.canvas_scale) for c in [xc1, yc1, xc2, yc2]]
    ...
    def minDistance(self, src, current_dist_list):
        ...
        for node_id in sorted_dists:
            if self.sptSet[node_id] is False:
                return node_id
    ...
    def dijkstra(self, src, canvas_scale):
                ...
                if self.sptSet[v] is False:
                    ...
                    if dist_uv != -1:
                        if dist[v] > dist[u] + dist_uv:
                            ...
                            # Node is a router
                            if self.node_list[v].type == 'router':
                                self.node_list[v].connection_tier = 0
                            # Node is connected to router
                            elif self.node_list[u].type == 'router':
