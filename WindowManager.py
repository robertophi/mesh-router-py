...
class WindowManager():
    ...
    def setup_controls(self):
        ...
        self.controls_manager.button4.config(command=self.change_canvas_scale)
    ...
    def change_canvas_scale(self):
        if self.mesh_manager.canvas_scale == 0.5:
            new_scale = 1
        else:
            new_scale = 0.5
        self.mesh_manager.update_canvas_scale(new_scale=new_scale)
        self.mesh_manager.update_canvas_complete()
